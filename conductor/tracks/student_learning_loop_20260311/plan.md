...
- [ ] Task: Conductor - Manual Verification 'Navigation and Lesson Entry'
...
- [ ] Task: Conductor - Manual Verification 'Lesson Type Delivery'
...
- [ ] Task: Conductor - Manual Verification 'Quiz, Completion, and Next Step'
