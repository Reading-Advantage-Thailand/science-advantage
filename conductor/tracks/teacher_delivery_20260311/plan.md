...
- [ ] Task: Conductor - Manual Verification 'Class Detail Control Surface'
...
- [ ] Task: Conductor - Manual Verification 'Lesson Preview and Assignment Flow'
...
- [ ] Task: Document teacher delivery workflows
  ...
  - [ ] Record unresolved teacher workflow debt in `conductor/tech-debt.md`
- [ ] Task: Conductor - Manual Verification 'Teacher Delivery QA'
