...
export const sessionFindFirstSchema: z.ZodType<Prisma.sessionFindFirstArgs> = z.object({ select: sessionFindFirstSelectSchema.optional(), include: sessionIncludeObjectSchema.optional(), orderBy: z.union([sessionOrderByWithRelationInputObjectSchema, sessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: sessionWhereInputObjectSchema.optional(), cursor: sessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SessionScalarFieldEnumSchema, SessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.sessionFindFirstArgs>;

export const sessionFindFirstZodSchema = z.object({ select: sessionFindFirstSelectSchema.optional(), include: sessionIncludeObjectSchema.optional(), orderBy: z.union([sessionOrderByWithRelationInputObjectSchema, sessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: sessionWhereInputObjectSchema.optional(), cursor: sessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SessionScalarFieldEnumSchema, SessionScalarFieldEnumSchema.array()]).optional() }).strict();