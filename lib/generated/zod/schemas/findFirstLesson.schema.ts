...
export const LessonFindFirstSelectSchema: z.ZodType<Prisma.LessonSelect> = z.object({
...
export const LessonFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    slug: z.boolean().optional(),
    title: z.boolean().optional(),
    titleThai: z.boolean().optional(),
...
export const LessonFindFirstSchema: z.ZodType<Prisma.LessonFindFirstArgs> = z.object({ select: LessonFindFirstSelectSchema.optional(), include: LessonIncludeObjectSchema.optional(), orderBy: z.union([LessonOrderByWithRelationInputObjectSchema, LessonOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonWhereInputObjectSchema.optional(), cursor: LessonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonScalarFieldEnumSchema, LessonScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LessonFindFirstArgs>;

export const LessonFindFirstZodSchema = z.object({ select: LessonFindFirstSelectSchema.optional(), include: LessonIncludeObjectSchema.optional(), orderBy: z.union([LessonOrderByWithRelationInputObjectSchema, LessonOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonWhereInputObjectSchema.optional(), cursor: LessonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonScalarFieldEnumSchema, LessonScalarFieldEnumSchema.array()]).optional() }).strict();