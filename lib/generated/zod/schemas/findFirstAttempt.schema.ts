...
export const AttemptFindFirstSchema: z.ZodType<Prisma.AttemptFindFirstArgs> = z.object({ select: AttemptFindFirstSelectSchema.optional(), include: AttemptIncludeObjectSchema.optional(), orderBy: z.union([AttemptOrderByWithRelationInputObjectSchema, AttemptOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttemptWhereInputObjectSchema.optional(), cursor: AttemptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttemptScalarFieldEnumSchema, AttemptScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AttemptFindFirstArgs>;

export const AttemptFindFirstZodSchema = z.object({ select: AttemptFindFirstSelectSchema.optional(), include: AttemptIncludeObjectSchema.optional(), orderBy: z.union([AttemptOrderByWithRelationInputObjectSchema, AttemptOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttemptWhereInputObjectSchema.optional(), cursor: AttemptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttemptScalarFieldEnumSchema, AttemptScalarFieldEnumSchema.array()]).optional() }).strict();