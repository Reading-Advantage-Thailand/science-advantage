...
export const MasteryRunFindFirstSelectSchema: z.ZodType<Prisma.MasteryRunSelect> = z.object({
...
export const MasteryRunFindFirstSelectZodSchema = z.object({
    attemptId: z.boolean().optional(),
    studentId: z.boolean().optional(),
    status: z.boolean().optional(),
    updatedCount: z.boolean().optional(),
...
export const MasteryRunFindFirstSchema: z.ZodType<Prisma.MasteryRunFindFirstArgs> = z.object({ select: MasteryRunFindFirstSelectSchema.optional(), include: MasteryRunIncludeObjectSchema.optional(), orderBy: z.union([MasteryRunOrderByWithRelationInputObjectSchema, MasteryRunOrderByWithRelationInputObjectSchema.array()]).optional(), where: MasteryRunWhereInputObjectSchema.optional(), cursor: MasteryRunWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MasteryRunScalarFieldEnumSchema, MasteryRunScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MasteryRunFindFirstArgs>;

export const MasteryRunFindFirstZodSchema = z.object({ select: MasteryRunFindFirstSelectSchema.optional(), include: MasteryRunIncludeObjectSchema.optional(), orderBy: z.union([MasteryRunOrderByWithRelationInputObjectSchema, MasteryRunOrderByWithRelationInputObjectSchema.array()]).optional(), where: MasteryRunWhereInputObjectSchema.optional(), cursor: MasteryRunWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MasteryRunScalarFieldEnumSchema, MasteryRunScalarFieldEnumSchema.array()]).optional() }).strict();