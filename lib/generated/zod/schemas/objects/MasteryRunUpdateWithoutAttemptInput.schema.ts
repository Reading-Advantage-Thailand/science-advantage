...
import { userUpdateOneRequiredWithoutMasteryRunsNestedInputObjectSchema as userUpdateOneRequiredWithoutMasteryRunsNestedInputObjectSchema } from './userUpdateOneRequiredWithoutMasteryRunsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  student: z.lazy(() => userUpdateOneRequiredWithoutMasteryRunsNestedInputObjectSchema).optional()
}).strict();
export const MasteryRunUpdateWithoutAttemptInputObjectSchema: z.ZodType<Prisma.MasteryRunUpdateWithoutAttemptInput> = makeSchema() as unknown as z.ZodType<Prisma.MasteryRunUpdateWithoutAttemptInput>;
export const MasteryRunUpdateWithoutAttemptInputObjectZodSchema = makeSchema();
