...
import { userUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema as userUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema } from './userUpdateOneRequiredWithoutLessonCompletionsNestedInput.schema';
import { LessonUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema as LessonUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema } from './LessonUpdateOneRequiredWithoutLessonCompletionsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  student: z.lazy(() => userUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema).optional(),
  lesson: z.lazy(() => LessonUpdateOneRequiredWithoutLessonCompletionsNestedInputObjectSchema).optional()
}).strict();
export const LessonCompletionUpdateInputObjectSchema: z.ZodType<Prisma.LessonCompletionUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.LessonCompletionUpdateInput>;
export const LessonCompletionUpdateInputObjectZodSchema = makeSchema();
