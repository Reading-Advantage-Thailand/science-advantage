...
export const LessonCompletionFindFirstSelectSchema: z.ZodType<Prisma.LessonCompletionSelect> = z.object({
...
export const LessonCompletionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    studentId: z.boolean().optional(),
    lessonId: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const LessonCompletionFindFirstSchema: z.ZodType<Prisma.LessonCompletionFindFirstArgs> = z.object({ select: LessonCompletionFindFirstSelectSchema.optional(), include: LessonCompletionIncludeObjectSchema.optional(), orderBy: z.union([LessonCompletionOrderByWithRelationInputObjectSchema, LessonCompletionOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonCompletionWhereInputObjectSchema.optional(), cursor: LessonCompletionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonCompletionScalarFieldEnumSchema, LessonCompletionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LessonCompletionFindFirstArgs>;

export const LessonCompletionFindFirstZodSchema = z.object({ select: LessonCompletionFindFirstSelectSchema.optional(), include: LessonCompletionIncludeObjectSchema.optional(), orderBy: z.union([LessonCompletionOrderByWithRelationInputObjectSchema, LessonCompletionOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonCompletionWhereInputObjectSchema.optional(), cursor: LessonCompletionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonCompletionScalarFieldEnumSchema, LessonCompletionScalarFieldEnumSchema.array()]).optional() }).strict();