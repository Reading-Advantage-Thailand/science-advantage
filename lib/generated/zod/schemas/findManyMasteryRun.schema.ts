...
export const MasteryRunFindManySelectSchema: z.ZodType<Prisma.MasteryRunSelect> = z.object({
...
export const MasteryRunFindManySelectZodSchema = z.object({
    attemptId: z.boolean().optional(),
    studentId: z.boolean().optional(),
    status: z.boolean().optional(),
    updatedCount: z.boolean().optional(),
...
export const MasteryRunFindManySchema: z.ZodType<Prisma.MasteryRunFindManyArgs> = z.object({ select: MasteryRunFindManySelectSchema.optional(), include: MasteryRunIncludeObjectSchema.optional(), orderBy: z.union([MasteryRunOrderByWithRelationInputObjectSchema, MasteryRunOrderByWithRelationInputObjectSchema.array()]).optional(), where: MasteryRunWhereInputObjectSchema.optional(), cursor: MasteryRunWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MasteryRunScalarFieldEnumSchema, MasteryRunScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MasteryRunFindManyArgs>;

export const MasteryRunFindManyZodSchema = z.object({ select: MasteryRunFindManySelectSchema.optional(), include: MasteryRunIncludeObjectSchema.optional(), orderBy: z.union([MasteryRunOrderByWithRelationInputObjectSchema, MasteryRunOrderByWithRelationInputObjectSchema.array()]).optional(), where: MasteryRunWhereInputObjectSchema.optional(), cursor: MasteryRunWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MasteryRunScalarFieldEnumSchema, MasteryRunScalarFieldEnumSchema.array()]).optional() }).strict();