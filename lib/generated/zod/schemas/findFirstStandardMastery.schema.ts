...
export const StandardMasteryFindFirstSelectSchema: z.ZodType<Prisma.StandardMasterySelect> = z.object({
...
export const StandardMasteryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    studentId: z.boolean().optional(),
    standardId: z.boolean().optional(),
    masteryLevel: z.boolean().optional(),
...
export const StandardMasteryFindFirstSchema: z.ZodType<Prisma.StandardMasteryFindFirstArgs> = z.object({ select: StandardMasteryFindFirstSelectSchema.optional(), include: StandardMasteryIncludeObjectSchema.optional(), orderBy: z.union([StandardMasteryOrderByWithRelationInputObjectSchema, StandardMasteryOrderByWithRelationInputObjectSchema.array()]).optional(), where: StandardMasteryWhereInputObjectSchema.optional(), cursor: StandardMasteryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StandardMasteryScalarFieldEnumSchema, StandardMasteryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StandardMasteryFindFirstArgs>;

export const StandardMasteryFindFirstZodSchema = z.object({ select: StandardMasteryFindFirstSelectSchema.optional(), include: StandardMasteryIncludeObjectSchema.optional(), orderBy: z.union([StandardMasteryOrderByWithRelationInputObjectSchema, StandardMasteryOrderByWithRelationInputObjectSchema.array()]).optional(), where: StandardMasteryWhereInputObjectSchema.optional(), cursor: StandardMasteryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StandardMasteryScalarFieldEnumSchema, StandardMasteryScalarFieldEnumSchema.array()]).optional() }).strict();