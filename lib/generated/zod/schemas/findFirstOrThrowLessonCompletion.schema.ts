...
export const LessonCompletionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LessonCompletionSelect> = z.object({
...
export const LessonCompletionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    studentId: z.boolean().optional(),
    lessonId: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const LessonCompletionFindFirstOrThrowSchema: z.ZodType<Prisma.LessonCompletionFindFirstOrThrowArgs> = z.object({ select: LessonCompletionFindFirstOrThrowSelectSchema.optional(), include: LessonCompletionIncludeObjectSchema.optional(), orderBy: z.union([LessonCompletionOrderByWithRelationInputObjectSchema, LessonCompletionOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonCompletionWhereInputObjectSchema.optional(), cursor: LessonCompletionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonCompletionScalarFieldEnumSchema, LessonCompletionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LessonCompletionFindFirstOrThrowArgs>;

export const LessonCompletionFindFirstOrThrowZodSchema = z.object({ select: LessonCompletionFindFirstOrThrowSelectSchema.optional(), include: LessonCompletionIncludeObjectSchema.optional(), orderBy: z.union([LessonCompletionOrderByWithRelationInputObjectSchema, LessonCompletionOrderByWithRelationInputObjectSchema.array()]).optional(), where: LessonCompletionWhereInputObjectSchema.optional(), cursor: LessonCompletionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LessonCompletionScalarFieldEnumSchema, LessonCompletionScalarFieldEnumSchema.array()]).optional() }).strict();