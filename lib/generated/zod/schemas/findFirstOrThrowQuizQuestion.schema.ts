...
export const QuizQuestionFindFirstOrThrowSchema: z.ZodType<Prisma.QuizQuestionFindFirstOrThrowArgs> = z.object({ select: QuizQuestionFindFirstOrThrowSelectSchema.optional(), include: QuizQuestionIncludeObjectSchema.optional(), orderBy: z.union([QuizQuestionOrderByWithRelationInputObjectSchema, QuizQuestionOrderByWithRelationInputObjectSchema.array()]).optional(), where: QuizQuestionWhereInputObjectSchema.optional(), cursor: QuizQuestionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QuizQuestionScalarFieldEnumSchema, QuizQuestionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.QuizQuestionFindFirstOrThrowArgs>;

export const QuizQuestionFindFirstOrThrowZodSchema = z.object({ select: QuizQuestionFindFirstOrThrowSelectSchema.optional(), include: QuizQuestionIncludeObjectSchema.optional(), orderBy: z.union([QuizQuestionOrderByWithRelationInputObjectSchema, QuizQuestionOrderByWithRelationInputObjectSchema.array()]).optional(), where: QuizQuestionWhereInputObjectSchema.optional(), cursor: QuizQuestionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QuizQuestionScalarFieldEnumSchema, QuizQuestionScalarFieldEnumSchema.array()]).optional() }).strict();