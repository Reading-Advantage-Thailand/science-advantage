...
export const ClassFindFirstSelectSchema: z.ZodType<Prisma.ClassSelect> = z.object({
...
export const ClassFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    gradeLevel: z.boolean().optional(),
    standardsAlignment: z.boolean().optional(),
...
export const ClassFindFirstSchema: z.ZodType<Prisma.ClassFindFirstArgs> = z.object({ select: ClassFindFirstSelectSchema.optional(), include: ClassIncludeObjectSchema.optional(), orderBy: z.union([ClassOrderByWithRelationInputObjectSchema, ClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClassWhereInputObjectSchema.optional(), cursor: ClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClassScalarFieldEnumSchema, ClassScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClassFindFirstArgs>;

export const ClassFindFirstZodSchema = z.object({ select: ClassFindFirstSelectSchema.optional(), include: ClassIncludeObjectSchema.optional(), orderBy: z.union([ClassOrderByWithRelationInputObjectSchema, ClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClassWhereInputObjectSchema.optional(), cursor: ClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClassScalarFieldEnumSchema, ClassScalarFieldEnumSchema.array()]).optional() }).strict();