...
export const AssignmentFindManySelectSchema: z.ZodType<Prisma.AssignmentSelect> = z.object({
...
export const AssignmentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    classId: z.boolean().optional(),
    lessonId: z.boolean().optional(),
    assignedAt: z.boolean().optional(),
