...
export const sessionFindFirstOrThrowSchema: z.ZodType<Prisma.sessionFindFirstOrThrowArgs> = z.object({ select: sessionFindFirstOrThrowSelectSchema.optional(), include: sessionIncludeObjectSchema.optional(), orderBy: z.union([sessionOrderByWithRelationInputObjectSchema, sessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: sessionWhereInputObjectSchema.optional(), cursor: sessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SessionScalarFieldEnumSchema, SessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.sessionFindFirstOrThrowArgs>;

export const sessionFindFirstOrThrowZodSchema = z.object({ select: sessionFindFirstOrThrowSelectSchema.optional(), include: sessionIncludeObjectSchema.optional(), orderBy: z.union([sessionOrderByWithRelationInputObjectSchema, sessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: sessionWhereInputObjectSchema.optional(), cursor: sessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SessionScalarFieldEnumSchema, SessionScalarFieldEnumSchema.array()]).optional() }).strict();