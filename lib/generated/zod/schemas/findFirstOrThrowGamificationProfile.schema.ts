...
export const GamificationProfileFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GamificationProfileSelect> = z.object({
...
export const GamificationProfileFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    xp: z.boolean().optional(),
    level: z.boolean().optional(),
